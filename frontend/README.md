...
| Linting       | ESLint                                                              |
| Formatting    | Prettier                                                            |
| Git Hooks     | Husky + lint-staged _(configured here, run from the monorepo root)_ |
