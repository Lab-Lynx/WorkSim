...
export const renderPasswordResetEmail = ({
  ...
  const subject = 'Reset your WorkSim password';

  const text = `Hello,

We received a request to reset the password for your WorkSim account.
...
<body>
  <div class="container">
    ...
    <p>We received a request to reset your password for WorkSim. Click the button below to choose a new password:</p>
    <div>
